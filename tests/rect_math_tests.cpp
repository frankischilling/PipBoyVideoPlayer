...
void RunRectMathTests() {
    ...
    constexpr FloatRect accepted_ui_rect{42.0f, 375.0f, 426.0f, 591.0f};
    constexpr std::array<MatrixCase, 6> matrix{{
        {{1280.0f, 960.0f}, {1280.0f, 960.0f}, {42.0f, 375.0f, 426.0f, 591.0f}},
        {{1706.666667f, 960.0f}, {1280.0f, 720.0f}, {31.5f, 281.25f, 319.5f, 443.25f}},
        {{1706.666667f, 960.0f}, {1920.0f, 1080.0f}, {47.25f, 421.875f, 479.25f, 664.875f}},
        {{1706.666667f, 960.0f}, {2560.0f, 1440.0f}, {63.0f, 562.5f, 639.0f, 886.5f}},
        {{1536.0f, 960.0f}, {1920.0f, 1200.0f}, {52.5f, 468.75f, 532.5f, 738.75f}},
        {{2293.333333f, 960.0f}, {3440.0f, 1440.0f}, {63.0f, 562.5f, 639.0f, 886.5f}},
    }};
