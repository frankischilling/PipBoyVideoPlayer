...
Run `scripts/generate-media-fixtures.ps1` to regenerate the eight deterministic files. The script refuses a different generator binary and verifies every fixture hash.
