...
try {
    ...
    $lines.Add('10:10:00.001 [INFO] Renderer summary: callbacks=10000 visible=9000 devices=1 video-submitted=1800 video-uploaded=1800 mailbox-replaced=0 mailbox-cleared=0 upload-successes=1804 upload-attempts=1804 upload-failures=0 upload-us=18.00/25.00/60.00')
    ...
    $rendererLine = '10:10:00.001 [INFO] Renderer summary: callbacks=10000 visible=9000 devices=1 video-submitted=1800 video-uploaded=1800 mailbox-replaced=0 mailbox-cleared=0 upload-successes=1804 upload-attempts=1804 upload-failures=0 upload-us=18.00/25.00/60.00'
    $badCases = [ordered]@{
        ...
        UploadCoverage = $good.Replace(
            'upload-successes=1804 upload-attempts=1804',
            'upload-successes=1799 upload-attempts=1799')
