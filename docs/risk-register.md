...
| Audio underruns on slower systems | Low to medium until the 12-item live retest | High | Let 12 bounded 30 FPS video items cover more time than the 16-item decoded audio queue so audio supplies worker backpressure | Six items failed after 56.4 seconds; 12 items passed a five-minute native 100 ms cadence run with zero underruns | Phases 3 and 4 |
