...
| --- | --- | --- | --- | --- | --- |
| No safe Pip-Boy render point exists | Medium to high | Project-blocking | The frame-present path failed layer order because it covers all UIO controls; inspect and test credible engine-owned points before menu rendering | The Extended fullscreen 1920x1080 layer probe showed the checkerboard but neither overlapping UIO element | Phase 1 |
