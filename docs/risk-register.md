...
| FFmpeg consumes too much 32-bit address space | Medium until the bounded-output live retest | High | Keep the 1080p input cap, scale queued BGRA frames within 512 by 512, retain byte and count queue limits, and repeat the live memory measurement | The first 1280 by 720 BGRA allocation failed in loaded VNV despite a 1,536,557,056-byte free region; a 512 by 288 frame needs 589,824 bytes | Phase 4 |
