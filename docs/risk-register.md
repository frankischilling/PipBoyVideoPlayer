...
| UI rectangle is not portable across Pip-Boy layouts | Medium | High | Keep the accepted raised 384 by 216 locus-owned panel, then test every remaining required layout, resolution, and scale | The raised position passed Base, full Extended, and isolated Vanilla UI Plus at 1920x1080 | Phases 1 and 5 |
