...
| --- | --- | --- | --- | --- | --- |
| No safe Pip-Boy render point exists | Low | Project-blocking | A visible native D3D9 draw is verified; next test layer order, state isolation, and device recovery | The Extended fullscreen 1920x1080 run displayed the generated checkerboard | Phase 1 |
