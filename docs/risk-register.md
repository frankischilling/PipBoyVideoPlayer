...
| UI rectangle is not portable across Pip-Boy layouts | Low at tested 4:3 and 16:9 sizes, unmeasured on ultrawide | High | Keep the accepted raised 384 by 216 locus-owned panel, then test the remaining ultrawide resolution and scale | The raised position passed all four UI profiles at 1920x1080 and full Extended at 1280x720, 1280x960, and 2560x1440 | Phases 1 and 5 |
