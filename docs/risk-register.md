...
| UI rectangle is not portable across Pip-Boy layouts | Low at 720p and 1080p, unmeasured elsewhere | High | Keep the accepted raised 384 by 216 locus-owned panel, then test every remaining required resolution and scale | The raised position passed all four isolated UI profiles at 1920x1080 and full Extended at 1280x720 | Phases 1 and 5 |
