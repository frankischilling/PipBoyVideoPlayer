...
| FFmpeg consumes too much 32-bit address space | Medium until the bounded-output live retest | High | Keep the 1080p input cap, scale queued BGRA frames within 512 by 512, retain byte and count queue limits, and repeat the live memory measurement | The first source-sized 720p BGRA allocation failed in VNV; the bounded native test held three 512 by 288 frames in 1,769,472 bytes and started the long file | Phase 4 |
