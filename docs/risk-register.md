...
| Audio underruns on slower systems | Medium until the six-item live retest | High | Reclaim completed XAudio2 slots before readiness and allow six video items under the unchanged 32 MiB cap so interleaved packet bursts can reach audio | The 30-second native 100 ms cadence run passed with zero underruns; the live five-minute gate remains open | Phases 3 and 4 |
