...
The Phase 1 diagnostic stage uses a 12-unit lower-left inset within the active Pip-Boy content rectangle. This location is provisional. Phase 5 must test the final playback-stage size and page-specific visibility against every supported UI profile before treating the diagnostic geometry as a release contract.
